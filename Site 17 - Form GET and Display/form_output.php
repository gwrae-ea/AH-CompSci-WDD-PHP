...
// Receive GET data and store in PHP variables
...
<head>
  ...
  <title>Form Output - Site 17</title>
  ...
  <main>
    ...
    <?php elseif ($has_data): ?>
      ...
      <div class="results-container">
        ...
        <h2>Data Flow</h2>
        <div class="code-note">
          <p><strong>URL Query String:</strong></p>
          <p><code><?php echo htmlspecialchars($_SERVER['QUERY_STRING'] ?? '(empty)'); ?></code></p>
