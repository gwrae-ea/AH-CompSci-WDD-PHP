...
$tasks = array(
    'Receive first_name from $_GET' => !empty($first_name),
    'Receive last_name from $_GET' => !empty($last_name),
...
<body>
  ...
  <main>
    ...
    <ol>
      ...
      <li>Set the form method to GET and action to a processing page.</li>
      <li>The processing page must receive $_GET data and store it in PHP variables.</li>
    ...
    <div class="code-note">
      ...
      <ol>
        <li>Receive at least two form fields via GET.</li>
