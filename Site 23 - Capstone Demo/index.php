...
<body>
  ...
  <main>
    <p>This lesson brings together the key skills from Sites 1-22 into one practical workflow: collect user input, validate it safely on the server, process it with PHP logic, and present responsive output pages.</p>
