...
<head>
  ...
  <title>Form Input - Site 18</title>
...
<body>
  ...
  <main>
    <div class="code-note">
      ...
      <p>When you submit, the form data will be sent in the request body and processed on the next page.</p>
    </div>

    <form method="POST" action="form_output.php" class="form-container">
      <fieldset>
    ...
    <div class="code-note">
      <p><strong>Try it:</strong> Fill in the form above and click Submit. The page will send your input without adding it to the URL, then page 2 will process and display it.</p>
    </div>
